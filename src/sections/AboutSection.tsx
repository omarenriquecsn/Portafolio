  ...
  return (
    ...
    >
      ...
      <div className="flex max-w-6xl mx-auto">
        <div className="max-w-4xl flex flex-col justify-center items-start mr-20">
          <div className="">
          ...
          <div className={`${ibmPlexMono.className} bg-[#292F36] max-w-3xl p-5 rounded-3xl font-[IMB-Plex-Mono]`}>
        ...
        <div>
          <Image src="/image.png" width={400} height={600} alt="decorador" />
        </div>
      </div>
    </section>
  );
